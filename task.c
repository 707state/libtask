...
int anyready(void) { return taskrunqueue.head != nil; }

void taskexitall(int val) { exit(val); }
...
void **taskdata(void) { return &taskrunning->udata; }
...
char *taskgetname(void) { return taskrunning->name; }
...
char *taskgetstate(void) { return taskrunning->state; }
...
unsigned int taskid(void) { return taskrunning->id; }
